...
namespace DeepCoin.Net.Interfaces.Clients
{
    ...
    public interface IDeepCoinUserClientProvider : IExchangeService
    {
        ...
        void InitializeUserClient(string userIdentifier, ApiCredentials credentials, DeepCoinEnvironment? environment = null);
        ...
        /// <param name="environment">The environment to use</param>
        IDeepCoinRestClient GetRestClient(string userIdentifier, ApiCredentials? credentials = null, DeepCoinEnvironment? environment = null);
        ...
        /// <param name="credentials">The credentials for the user. Required the first time a client is requested for this user unless <see cref="InitializeUserClient" /> has been called prior for this user.</param>
        /// <param name="environment">The environment to use</param>
        IDeepCoinSocketClient GetSocketClient(string userIdentifier, ApiCredentials? credentials = null, DeepCoinEnvironment? environment = null);
    }
}