...
namespace DeepCoin.Net.Converters
{
    ...
    [JsonSerializable(typeof(DeepCoinResponse<DeepCoinV2WithdrawPage>))]
    [JsonSerializable(typeof(DeepCoinResponse<DeepCoinV2FundingRate[]>))]
    [JsonSerializable(typeof(DeepCoinResponse<DeepCoinV2ServerTime>))]
    [JsonSerializable(typeof(DeepCoinResponse<DeepCoinV2OrderQueryResult[]>))]
    [JsonSerializable(typeof(DeepCoinResponse<DeepCoinV2ClosePositionResponse>))]
    [JsonSerializable(typeof(SocketRequest))]
    [JsonSerializable(typeof(DeepCoinV2SocketRequest))]
    [JsonSerializable(typeof(DeepCoinV2SocketMessage))]
    [JsonSerializable(typeof(DeepCoinV2SymbolMessage))]
    [JsonSerializable(typeof(DeepCoinV2TradeMessage))]
    [JsonSerializable(typeof(DeepCoinV2KlineMessage))]
    [JsonSerializable(typeof(DeepCoinV2OrderBookMessage))]
    [JsonSerializable(typeof(DeepCoinV2SymbolData[]))]
    [JsonSerializable(typeof(DeepCoinV2OrderBookData[]))]
    ...
    [JsonSerializable(typeof(DeepCoinResponse<DeepCoinCurrentFundingRates>))]
