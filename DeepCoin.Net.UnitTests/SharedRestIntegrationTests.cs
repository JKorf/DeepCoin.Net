...
namespace DeepCoin.Net.UnitTests
{
    ...
    internal class SharedRestIntegrationTests
    {
        ...
        private IDeepCoinRestClientExchangeApiShared GetRestClient()
        {
            var collection = new ServiceCollection();
            collection.AddDeepCoin(x => x.Rest.OutputOriginalData = true);
            ...
            return sp.GetRequiredService<IDeepCoinRestClient>().ExchangeApi.SharedClient;
        }
